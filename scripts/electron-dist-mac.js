...
spawnSync('node node_modules/electron-packager/cli.js dist/main.js ' + (process.env.npm_package_name || 'app') + ' --platform darwin --arch x64 --overwrite', {stdio: 'inherit', shell: true});
